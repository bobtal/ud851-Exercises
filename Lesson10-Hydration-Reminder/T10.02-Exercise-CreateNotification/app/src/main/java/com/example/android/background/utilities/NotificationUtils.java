...
public class NotificationUtils {
    ...
    public static final int PENDING_INTENT_ID = 11;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "water-reminder-channel";
    private static final int DRINK_WATER_NOTIFICATION_ID = 15;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (notificationManager != null) {
            notificationManager.notify(DRINK_WATER_NOTIFICATION_ID, builder.build());
        }
    }
